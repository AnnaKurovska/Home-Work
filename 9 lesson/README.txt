...
Есть файл index.html, вы должны стилизировать его согласно требованиям:
    ...
    - добавьте на станицу кнопку вверх используя только те цвета что есть в существующей странице при клике на которую я буду перемещаться на верх страницы
    - ограничте высоту h3 в документе той высотой которая у него есть и сделайте так чтобы как в случаэ с 1 блоком текст не переносился на другую строку а чтобы он заканчивался тремя точками (что бы верстка не ламалась если вдруг название блоков будут больше чем есть сейчас)
